      ...
      <div class="navbar-vertical-content" style="background-color:#111827;">
        <ul class="navbar-nav flex-column" id="navbarVerticalNav">
          ...
          <li class="nav-item">
            ...
            <p class="navbar-vertical-label-under">Diseños de aplicaciones a la medida</p>
          ...
          <li class="nav-item">
            ...
            <p class="navbar-vertical-label-under">Diseños de página personalizados</p>
            <hr class="navbar-vertical-line" />
            <!-- parent pages-->
                  ...
                  <li class="nav-item"><a class="nav-link dropdown-indicator" href="#split" data-bs-toggle="collapse" aria-expanded="false" aria-controls="authentication">
                    ...
                    <div class="parent-wrapper">
                      <ul class="nav collapse parent" data-bs-parent="#authentication" id="split">
                        <li class="nav-item"><a class="nav-link" href="pages/authentication/split/sign-in.jsp" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text">Sign in</span>
                            </div>
                          </a>
                          <!-- more inner pages-->
                  ...
                  <li class="nav-item"><a class="nav-link dropdown-indicator" href="#Card" data-bs-toggle="collapse" aria-expanded="false" aria-controls="authentication">
                    ...
                    <div class="parent-wrapper">
                      <ul class="nav collapse parent" data-bs-parent="#authentication" id="Card">
                        <li class="nav-item"><a class="nav-link" href="pages/authentication/card/sign-in.jsp" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text">Sign in</span>
                            </div>
                          </a>
                          <!-- more inner pages-->
          ...
          <li class="nav-item">
            ...
            <p class="navbar-vertical-label-under">Modulos del Sistema</p>
            <hr class="navbar-vertical-line" />
            <!-- parent pages-->
          ...
          <li class="nav-item">
            ...
            <p class="navbar-vertical-label-under">Documentos asociados</p>
            <hr class="navbar-vertical-line" />
            <!-- parent pages-->
