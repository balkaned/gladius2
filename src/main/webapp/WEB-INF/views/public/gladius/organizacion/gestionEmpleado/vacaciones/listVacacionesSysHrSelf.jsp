                            ...
                            <div class="mb-8">
                                <div>
                                  ...
                                  <div class="col-12 mt-4 mb-2 d-flex justify-content-end">
                                      ...
                                      <a class="btn btn-primary ms-1 btn-sm disabled" onclick="actualizar();" href="actualizarVacEmpl@${idTrab}"><span class="fa-solid fas fa-wrench me-2"></span>Actualizar</a>
                                  </div>
                                </div>
