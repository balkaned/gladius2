                      ...
                      <div class="content2">
                          ...
                          <div class="mb-9">
                            <div class="row g-3 mb-4">
                              <div class="col-auto">
                                <h2 id="h2top" class="mb-0">Editar retención</h2>
                              </div>
                            </div>
                                   ...
                                   <div class="row gx-3 gy-4">
                                     <form class="row g-4 mb-0 needs-validation" method="POST" action="modificarRetencion" novalidate >
                                            ...
                                            <div class="col-sm-6 col-md-12">
                                                ...
                                                <input class="form-control" name="iexresolucion" maxlength="50" type="text" value="${requestScope.xRetenJudEmp.iexresolucion}" required />
                                            </div>
                                            <div class="col-sm-6 col-md-12">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <input class="form-control datetimepicker" name="iexfecini" id="iexfecini" onchange="formatearFecha1();" value="${requestScope.xRetenJudEmp.iexfecini}" type="text" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required />
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <input class="form-control datetimepicker" name="iexfecfin" id="iexfecfin" onchange="formatearFecha2();" type="text" value="${requestScope.xRetenJudEmp.iexfecfin}" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required />
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <input class="form-control" name="iexpordesct" maxlength="10" type="number" value="${requestScope.xRetenJudEmp.iexpordesct}"  step=0.01 placeholder="10%-> 10.0" required />
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">* Imp. Fijo</label>
                                                <input class="form-control" name="ieximpfijo" maxlength="10" step=0.01 type="number" value="${requestScope.xRetenJudEmp.ieximpfijo}" value="0.0" required />
                                            </div>
