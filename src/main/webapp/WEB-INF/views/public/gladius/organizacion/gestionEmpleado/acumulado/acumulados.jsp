                            ...
                            <div class="mb-8">
                                <div class="d-flex justify-content-between align-items-center mb-4" id="scrollspyDeals">
                                  ...
                                  <div class="col-auto">
                                      ...
                                      <a class="btn btn-primary btn-sm" href="nuevoAcumulado@${idTrab}"><span class="fa-solid fa-plus me-2"></span>Add Acumulado</a>
                                  </div>
                                </div>
                                    ...
                                    <table class="table fs--1 mb-0">
                                      <thead>
                                        <tr>
                                          ...
                                          <th class="sort white-space-nowrap align-middle pe-3 ps-0 text-uppercase" scope="col" data-sort="dealName" >Año</th>
                                          <th class="sort align-middle pe-6 text-uppercase text-center" scope="col" data-sort="amount" >Rem Afect 5ta Cia Anterior</th>
                                          <th class="sort align-middle text-center text-uppercase" scope="col" data-sort="stage" >Desc 5ta Cia Anterior</th>
