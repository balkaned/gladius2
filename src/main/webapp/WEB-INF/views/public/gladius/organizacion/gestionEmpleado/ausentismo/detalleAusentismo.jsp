                      ...
                      <div class="content2">
                          ...
                          <div class="mb-9">
                            <div class="row g-3 mb-4">
                              <div class="col-auto">
                                <h2 id="h2top" class="mb-0">Ver detalle ausentismo</h2>
                              </div>
                            </div>
                            <c:if test="${msg!=null}">
                            ...
                            <div class="row g-3">
                                 <div class="col-xl-10">
                                   <div class="row gx-3 gy-4">
                                     <form class="row g-3 mb-0 needs-validation" method="POST" id="formausentismo" name="formausentismo" action="modificarAusentismo" novalidate >
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <select class="form-select" name="iextipaus" required disabled>
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                ...
                                                <input class="form-control datetimepicker" name="iexfecini" id="iexfecini" value="${requestScope.xAusentismoDet.iexfecini}" onchange="formatearFecha1();" type="text"  placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required disabled/>
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                  ...
                                                  <input class="form-control datetimepicker" name="iexfecfin" id="iexfecfin" value="${requestScope.xAusentismoDet.iexfecfin}" type="text" onchange="calcularDias();" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required disabled/>
                                            ...
                                            <div class="col-sm-6 col-md-9">
                                                   ...
                                                   <input class="form-control" name="iexglosa" maxlength="70" type="text" value="${requestScope.xAusentismoDet.iexglosa}" disabled/>
                                            </div>
                                            ...
                                            <div class="col-12 gy-6">
                                                <div class="row g-3 justify-content-end">
                                                  ...
                                                  <div class="col-auto">
                                                    <button class="btn btn-primary disabled" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" >Guardar ausentismo</button>
                                                  </div>
                                                </div>
                                            </div>
