                ...
                <div class="mb-4">
                  <div class="row g-3">
                    <div class="col-auto">
                      <div class="search-box">
                        <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                          <input class="form-control search-input search" type="search" placeholder="Search puestos" aria-label="Search" />
                    ...
                    <div class="col-auto">
                      ...
                      <a class="btn btn-primary" href="nuevoPuesto"><span class="fas fa-plus me-2"></span>Add Puesto</a>
                    </div>
                  </div>
                </div>
                              ...
                              <td class="align-middle text-end white-space-nowrap pe-0 action">
                                 <div class="font-sans-serif btn-reveal-trigger position-static">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a id="dropdownmenutable" class="dropdown-item" href="editarPuesto@${puest.iexpuesto}"><span class="fa-solid fa-pencil me-2"></span>Editar</a>
                                        <div class="dropdown-divider"></div>
                                        <a id="dropdownmenutable" class="dropdown-item" onclick="return remove();" href="deleterPuesto@${puest.iexpuesto}"><span class="fa-solid fa-trash me-2"></span>Eliminar</a>
                                   </div>
                                 </div>
                              </td>
                            </tr>
