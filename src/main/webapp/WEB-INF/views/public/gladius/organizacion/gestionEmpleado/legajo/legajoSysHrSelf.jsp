                            ...
                            <div class="col-12 mt-5">
                                 <c:forEach var="listGrpFile" items="${requestScope.listGrpFile}"   varStatus="loopCounter" >
                                      <c:if test="${listGrpFile.iexdesgrpfile != permes_cur }">
                                           ...
                                           <div>
                                               <a class="btn btn-phoenix-secondary btn-sm mb-1 disabled" href="ingresarImagen@${idTrab}@${listGrpFile.iexcodgrpfile}@${codgrpfile}"><span class="fa-solid fas fa-plus me-2"></span>Add file</a>
                                               <a class="btn btn-phoenix-secondary btn-sm mb-1 disabled" href="editarGrupoArch@${idTrab}@${listGrpFile.iexcodgrpfile}@${codgrpfile}" ><span class="fas fa-pen me-2"></span>Editar grupoArch</a>
                                               <a class="btn btn-phoenix-danger btn-sm mb-1 disabled" onclick="return remove();" href="delGrupoArch@${idTrab}@${listGrpFile.iexcodgrpfile}@${codgrpfile}"><span class="fas fa-minus me-2"></span>Borrar</a>
                                           </div>
