                    ...
                    <div class="lead-details-container">
                      ...
                      <div class="tab-content" id="myTabContent">
                         <div class="tab-pane fade active show" id="tab-activity" role="tabpanel" aria-labelledby="activity-tab">
                            <h3 class="mt-3 mb-4">Datos personales</h3>
                            <div class="row g-3">
                                 <div class="col-xl-12">
                                     ...
                                     <form class="row g-3 mb-0 needs-validation" method="POST" action="updateEmplDatPers" novalidate >
                                        ...
                                        <div class="col-12 d-flex justify-content-end mt-6">
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <button class="btn btn-primary col-6 disabled" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" >Guardar</button>
                                            </div>
                                        </div>
                      ...
                      <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade" id="tab-notes" role="tabpanel" aria-labelledby="activity-tab">
                                <h3 class="mt-3 mb-4">Datos laborales</h3>
                                <div class="row g-3">
                                     <div class="col-xl-12">
                                       <div class="row gx-3 gy-4">
                                          <form class="row g-3 mb-0 needs-validation" method="POST" action="updateEmplDatLab" novalidate>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <select class="form-select" name="iexreglab" required disabled >
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                  ...
                                                  <select class="form-select" name="iexpuesto" required disabled >
                                            ...
                                            <div class="col-12 d-flex justify-content-end mt-6">
                                                <div class="col-sm-6 col-md-6">
                                                    <a class="btn btn-phoenix-primary" href="listEmpleados">Cancel</a>
                                                    <button class="btn btn-primary col-6 disabled" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal2" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" >Guardar</button>
                                                </div>
                                            </div>
                      ...
                      <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade" id="tab-meeting" role="tabpanel" aria-labelledby="activity-tab">
                                <h3 class="mt-3 mb-4">Información de pago</h3>
                                <div class="row g-3">
                                     <div class="col-xl-12">
                                       <div class="row gx-3 gy-4">
                                          <form class="row g-3 mb-0 needs-validation" method="POST" action="updateInfoPago" novalidate>
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                ...
                                                <input id="validationCustom01" class="form-control" type="number" maxlength="50" name="iexnrocta_cts" value="${requestScope.emp3.iexnrocta_cts}" placeholder="Ingrese el numero de cuenta cts" disabled />
                                            </div>
                                            ...
                                            <div class="col-12 d-flex justify-content-end mt-6">
                                                <div class="col-sm-6 col-md-6">
                                                    <a class="btn btn-phoenix-primary" href="listEmpleados">Cancel</a>
                                                    <button class="btn btn-primary col-6 disabled" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal3" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" >Guardar</button>
                                                </div>
                                            </div>
                      ...
                      <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade" id="tab-task" role="tabpanel" aria-labelledby="activity-tab">
                                <h3 class="mt-3 mb-4">Seguridad social</h3>
                                <div class="row g-3">
                                     <div class="col-xl-12">
                                       <div class="row gx-3 gy-4">
                                         <form class="row g-3 mb-0 needs-validation" method="POST" action="updateSegurSocial" novalidate >
                                            ...
                                            <div class="col-sm-6 col-md-12">
                                                <input class="form-check-input" name="iexflgeps" id="flexChecked" type="checkbox" value="1" ${requestScope.emp4.iexflgeps=='1' ? 'checked=true' : ''} disabled />
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                ...
                                                <select class="form-select" name="iexcodeps" required disabled >
                                            ...
                                            <div class="col-12 d-flex justify-content-end mt-6">
                                                <div class="col-sm-6 col-md-6">
                                                    <a class="btn btn-phoenix-primary" href="listEmpleados">Cancel</a>
                                                    <button class="btn btn-primary col-6 disabled" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal4" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" >Guardar</button>
                                                </div>
                                            </div>
                      ...
                      <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade" id="tab-call" role="tabpanel" aria-labelledby="activity-tab">
                              <h3 class="mt-3 mb-4">Datos domicilio</h3>
                              <div class="row g-3">
                                   <div class="col-xl-12">
                                     <div class="row gx-3 gy-4">
