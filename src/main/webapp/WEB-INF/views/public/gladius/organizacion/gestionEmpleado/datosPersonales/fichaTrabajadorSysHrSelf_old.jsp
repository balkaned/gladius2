                                   ...
                                   <div class="row gx-3 gy-4">
                                     <form class="row g-4 mb-0 needs-validation" method="POST" action="updateEmplDatPers" novalidate >
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            ...
                                            <input class="form-control" name="iexcodant" maxlength="20" type="text" value="${requestScope.emp.iexcodant}" placeholder="#" disabled/>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            ...
                                            <input class="form-control" name="iexnrotelf" maxlength="20" type="text" value="${requestScope.emp.iexnrotelf}" placeholder="+51 987 673999" disabled/>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                        ...
                                        <div class="col-12 d-flex justify-content-end mt-6">
                                            <div class="col-sm-6 col-md-6">
                                                <a class="btn btn-phoenix-primary disabled" href="listEmpleados">Cancel</a>
                                       ...
                                       <div class="row gx-3 gy-4">
                                          <form class="row g-4 mb-0 needs-validation" method="POST" action="updateEmplDatLab" novalidate>
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                  ...
                                                  <input class="form-control datetimepicker" name="iexfecing" id="iexfecing" onchange="formatearFecha2();" value="${requestScope.emp2.iexfecing}" type="text" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required disabled/>
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                  ...
                                                  <select class="form-select" name="iexpliego" disabled>
                                                    <option value="" selected >Seleccionar</option>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <select class="form-select" name="iexocupacion_pub" disabled>
                                                    <option value="" selected >Seleccionar</option>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <select class="form-select" name="iexocupacion_priv" disabled>
                                                    <option value="" selected >Seleccionar</option>
                                       ...
                                       <div class="row gx-3 gy-4">
                                          <form class="row g-4 mb-0 needs-validation" method="POST" action="updateInfoPago" novalidate>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <input class="form-control" name="iexnrocta_hab" maxlength="50" value="${requestScope.emp3.iexnrocta_hab}" type="text" placeholder="#" required disabled/>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                  <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">* Banco de CTS [TT36]</label>
                                                  <select class="form-select" name="iexcodban_cts" required disabled>
                                                    <option value="" selected >Seleccionar</option>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <select class="form-select" name="iextipban_cts" required disabled>
                                                    <option value="" selected >Seleccionar</option>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <select class="form-select" name="iexcodmon_cts" required disabled>
                                                    <option value="" selected >Seleccionar</option>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <input id="validationCustom01" class="form-control" maxlength="50" name="iexnrocta_cts" value="${requestScope.emp3.iexnrocta_cts}" type="text" placeholder="#" required disabled/>
                                            </div>
                                       ...
                                       <div class="row gx-3 gy-4">
                                         <form class="row g-4 mb-0 needs-validation" method="POST" action="updateSegurSocial" novalidate >
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <input class="form-control" maxlength="50"name="iexcussp" value="${requestScope.emp4.iexcussp}" type="text" placeholder="#" required disabled/>
                                            </div>
                                            <div class="col-sm-6 col-md-8">
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                ...
                                                <input class="form-control" name="iexnroruc_cas" maxlength="20" id="floatingInputStreet" maxlength="11" value="${requestScope.emp4.iexnroruc_cas}" type="text" placeholder="#" disabled/>
                                            </div>
                                            <div class="col-sm-6 col-md-12">
                                        ...
                                        <form class="row g-4 mb-0 needs-validation" method="POST" action="updateEmplDatDomic" novalidate >
                                          ...
                                          <input class="form-control" name="iexcodtra" type="hidden" value="${requestScope.emp.iexcodtra}" />
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                  ...
                                                  <input class="form-control" name="iexreferencia_dom1" maxlength="40" value="${requestScope.emp5.iexreferencia_dom1}" type="text" placeholder="" disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-4">
                                                 <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">* Pais Emisor [TT26]</label>
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                  ...
                                                  <input class="form-control" name="iexreferencia_dom2" maxlength="40" value="${requestScope.emp5.iexreferencia_dom2}" type="text" placeholder="" disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-4">
                                            ...
                                            <div class="col-12 d-flex justify-content-end mt-6">
                                                  <div class="col-sm-6 col-md-6">
                                                      <a class="btn btn-phoenix-primary disabled" href="listEmpleados">Cancel</a>
                                                      <button class="btn btn-primary col-6 disabled" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal5" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" >Guardar</button>
                                                  </div>
                                            </div>
