          ...
          <div class="content">
            ...
            <div class="mb-9">
              <div class="row g-3 mb-4">
                <div class="col-auto">
                  <h2 id="h2top" class="mb-0">Insertar centro de costo</h2>
                </div>
              </div>
              ...
              <div class="row g-3">
                   <div class="col-xl-7">
                     <div class="row gx-3 gy-4">
                       <form class="row g-3 mb-0 needs-validation" method="POST" action="insertarCcosto" novalidate >
                              ...
                              <div class="col-sm-6 col-md-8">
                                    ...
                                    <input class="form-control" name="iexdesccosto" type="text" value="" placeholder="CC Multident" required/>
                              </div>
