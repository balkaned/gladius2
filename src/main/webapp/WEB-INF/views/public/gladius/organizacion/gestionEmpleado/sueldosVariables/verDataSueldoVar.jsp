                            ...
                            <div class="mb-8">
                               <div>
                                  ...
                                  <div class="col-12 mt-5 mb-2 d-flex justify-content-end">
                                      ...
                                      <a class="btn btn-primary ms-1 btn-sm" href="nuevoSueldoVar@${idTrab}@${iexcodpro}@${iexperiodo}"><span class="fa-solid fa-plus me-2"></span>Add Concepto</a>
                                  </div>
                               </div>
                                   ...
                                   <div class="col-12 col-sm-auto">
                                     <div class="row g-4 flex-sm-column">
                                       <div class="col-6 col-sm-12">
                                         ...
                                         </div><a class="fs--1 ms-4" href="!"><span class="badge bg-danger fs--2">${iexperiodo}</span></a>
                                       </div>
                                     </div>
                                   </div>
                               </div>

                               <div id="orderTable" data-list='{"valueNames":["id","des","val"],"page":10,"pagination":true}'>
                                        ...
                                        <table class="table table-sm fs--1 mb-0">
                                          <thead>
                                            <tr>
                                              ...
                                              <th class="sort align-middle text-center white-space-nowrap ps-3 pe-3 text-uppercase" scope="val" data-sort="payment_status" >Valor</th>
                                          ...
                                          <tbody class="list" id="customer-order-table-body">
                                            <c:forEach var="fdatavar" items="${requestScope.fdatavar}">
                                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                  <td class="id align-middle white-space-nowrap ps-3 pe-3 text-start"><a class="fw-semi-bold" href="editarSueldoVar@${idTrab}@${fdatavar.iexcodcon}@${iexcodpro}@${iexperiodo}">#${fdatavar.iexcodcon}</a></td>
                                                  <td class="des align-middle text-start fw-semi-bold ps-3 pe-3 text-1000"><span class="badge badge-phoenix fs--2 badge-phoenix-warning"><span class="badge-label">${fdatavar.coodescon}</span></td>
                                                  <td class="val align-middle white-space-nowrap text-center text-800 ps-3 pe-3">${fdatavar.iexvalcon}</td>
