          ...
          <div class="content bg-100">
            ...
            <div class="mb-9">
              <div class="row g-3 mb-4">
                <div class="col-auto">
                  <h2 id="h2top" class="mb-0">Insertar banco</h2>
                </div>
              </div>
              ...
              <div class="row g-3">
                   <div class="col-xl-8">
                     <div class="row gx-3 gy-4">
                       <form class="row g-3 mb-0 needs-validation" method="POST" action="insertarBanco" novalidate >
                              ...
                              <div class="col-sm-6 col-md-8">
                                   <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">Número de cuenta</label>
                                   <input class="form-control" name="iexctaban" maxlength="20" type="number" value="" placeholder="Ingrese el número de cuenta bancaria" required/>
                              </div>
