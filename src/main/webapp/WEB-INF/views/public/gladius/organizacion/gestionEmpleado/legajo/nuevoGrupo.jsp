                      ...
                      <div class="content2">
                          ...
                          <div class="mb-9">
                            <div class="row g-3 mb-4">
                              <div class="col-auto">
                                <h2 id="h2top" class="mb-0">Insertar nuevo grupo</h2>
                              </div>
                            </div>
                                   ...
                                   <div class="row gx-3 gy-4">
                                     <form class="row g-4 mb-0 needs-validation" method="POST" action="insertarGrupo" novalidate >
                                            ...
                                            <div class="col-sm-6 col-md-12">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none" for="inputCity">Grupo de Archivos (*)</label>
                                            ...
                                            <div class="col-sm-6 col-md-12">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none" for="inputAddress1">Descripcion File (*)</label>
