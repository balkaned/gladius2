                      ...
                      <div class="tab-content" id="myTabContent">
                         <div class="tab-pane fade active show" id="tab-activity" role="tabpanel" aria-labelledby="activity-tab">
                            <div class="mb-8">
                                ...
                                <div id="orderTable" data-list='{"valueNames":["id","nomapel","vinc","tipdoc","nrod","fecnac"],"page":10,"pagination":true}' >
                                            ...
                                            <table class="table table-sm fs--1 mb-0">
                                              <thead>
                                                <tr>
                                                  ...
                                                  <th class="sort align-middle text-center ps-5 pe-5 text-uppercase" scope="col" data-sort="nomapel">Nombres y Apellidos</th>
                                                  <th class="sort align-middle text-center white-space-nowrap ps-3 pe-3 text-uppercase" scope="col" data-sort="vinc" >Vinculo</th>
                                                  <th class="sort align-middle text-center white-space-nowrap ps-3 pe-3 text-uppercase" scope="col" data-sort="tipdoc" >Tipo Doc</th>
                                                  <th class="sort align-middle text-center white-space-nowrap text-start ps-3 pe-3 text-uppercase" scope="col" data-sort="nrod" >Nro Doc</th>
                                                  <th class="sort align-middle white-space-nowrap text-center text-uppercase ps-3 pe-3" scope="col" data-sort="fecnac" >Fec Nac</th>
                                              ...
                                              <tbody class="list" id="customer-order-table-body">
                                                <c:forEach var="LovDerhab" items="${requestScope.LovDerhab}">
                                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                      <td class="id align-middle white-space-nowrap ps-0"><a class="fw-semi-bold" href="editarDerechoHab@${idTrab}@${LovDerhab.iexcoddep}">#${LovDerhab.iexcoddep}</a></td>
                                                      <td class="nomapel align-middle white-space-nowrap pe-5 ps-5">
                                                      ...
                                                      <td class="vinc align-middle white-space-nowrap text-center text-700"><span class="badge badge-phoenix fs--2 badge-phoenix-info"><span class="badge-label">${LovDerhab.destipvinculo}</span></td>
                                                      <td class="tipdoc align-middle white-space-nowrap text-center text-700">${LovDerhab.destipnroiddep}</td>
                                                      <td class="nrod align-middle white-space-nowrap fs--1 text-700 text-center pe-4">${LovDerhab.iexnroiddep}</td>
                                                      <td class="fecnac align-middle white-space-nowrap text-end fw-semi-bold text-1000"><a href="#"><span class="fa-solid fa-calendar-days me-2"></span></a>${LovDerhab.iexfecnac}</td>
                                                      ...
                                                      <td class="align-middle white-space-nowrap text-end pe-0 ps-5">
                                                        <div class="font-sans-serif btn-reveal-trigger position-static">
                                                          ...
                                                          <div class="dropdown-menu dropdown-menu-end py-2">
                                                            ...
                                                            <a id="dropdownmenutable"  class="dropdown-item" href="editarDerechoHab@${idTrab}@${LovDerhab.iexcoddep}"><span class="fa-solid fa-pencil me-2"></span>Editar</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a id="dropdownmenutable"  class="dropdown-item" onclick="return remove();" href="deleteDerechoHab@${idTrab}@${LovDerhab.iexcoddep}"><span class="fa-solid fa-trash me-2"></span>Eliminar</a>
                                                          </div>
                                                        </div>
                                                      </td>
                                                    </tr>
