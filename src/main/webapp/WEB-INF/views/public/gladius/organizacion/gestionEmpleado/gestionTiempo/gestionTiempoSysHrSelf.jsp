                                                ...
                                                <td>
                                                    <div class="col-sm-6 col-md-7">
                                                        <table style="display: block;overflow-x: auto;white-space: nowrap;">
                                                            <tr>
                                                                <td class="text-body fs--1" > Lun <input type="checkbox" class="form-check-input text-body fs-9 " name="iexlunes" id="iexlunes" value="1" class="flat"  ${requestScope.xempxturno.iexlunes =='1' ? 'checked=true' : ''}   ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled > </td>
                                                                <td class="text-body fs--1"> Mar <input type="checkbox" class="form-check-input text-body fs-9 " name="iexmartes" id="iexmartes" value="1" class="flat" ${requestScope.xempxturno.iexmartes =='1' ? 'checked=true' : ''} ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'}  disabled >  </td>
                                                                <td class="text-body fs--1"> Mie <input type="checkbox" class="form-check-input text-body fs-9 " name="iexmiercoles" id="iexmiercoles" value="1" class="flat"  ${requestScope.xempxturno.iexmiercoles =='1' ? 'checked=true' : ''} ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'}  disabled >   </td>
                                                                <td class="text-body fs--1"> Jue <input type="checkbox" class="form-check-input text-body fs-9 " name="iexjueves" id="iexjueves" value="1" class="flat" ${requestScope.xempxturno.iexjueves =='1' ? 'checked=true' : ''} ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'}  disabled >   </td>
                                                                <td class="text-body fs--1"> Vie <input type="checkbox" class="form-check-input text-body fs-9 " name="iexviernes" id="iexviernes" value="1" class="flat" ${requestScope.xempxturno.iexviernes =='1' ? 'checked=true' : ''} ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >  </td>
                                                                <td class="text-body fs--1"> Sab <input type="checkbox" class="form-check-input text-body fs-9 " name="iexsabado" id="iexsabado" value="1" class="flat"  ${requestScope.xempxturno.iexsabado =='1' ? 'checked=true' : ''} ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >   </td>
                                                                <td class="text-body fs--1"> Dom <input type="checkbox" class="form-check-input text-body fs-9 " name="iexdomingo" id="iexdomingo" value="1" class="flat"  ${requestScope.xempxturno.iexdomingo =='1' ? 'checked=true' : ''} ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'}  disabled >   </td>
                                                           </tr>
                                                           <tr>
                                                               <td>
                                                                    <select name="iexturlun" style="width:150px; font-size:11px;" id="iexturlun" class="form-select form-select-sm" ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >
                                                               ...
                                                               <td>
                                                                    <select name="iexturmar" style="width:150px; font-size:11px;" id="iexturmar" class="form-select form-select-sm" ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >
                                                                       <option value="-1">-- --</option>
                                                                       <c:forEach  var="LstTurno" items="${LstTurno}">
                                                               ...
                                                               <td>
                                                                    <select name="iexturmie" style="width:150px; font-size:11px;" id="iexturmie" class="form-select form-select-sm" ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >
                                                                       <option value="-1">-- --</option>
                                                                       <c:forEach  var="LstTurno" items="${LstTurno}">
                                                               ...
                                                               <td>
                                                                    <select name="iexturjue" style="width:150px; font-size:11px;" id="iexturjue" class="form-select form-select-sm" ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >
                                                                       <option value="-1">-- --</option>
                                                                       <c:forEach  var="LstTurno" items="${LstTurno}">
                                                               ...
                                                               <td>
                                                                    <select name="iexturvie" style="width:150px; font-size:11px;" id="iexturvie" class="form-select form-select-sm" ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >
                                                                       <option value="-1">-- --</option>
                                                                       <c:forEach  var="LstTurno" items="${LstTurno}">
                                                               ...
                                                               <td>
                                                                    <select name="iextursab" style="width:150px; font-size:11px;" id="iextursab" class="form-select form-select-sm" ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >
                                                                       <option value="-1">-- --</option>
                                                                       <c:forEach  var="LstTurno" items="${LstTurno}"  >
                                                               ...
                                                               <td class="pe-10">
                                                                    <select name="iexturdom" style="width:150px; font-size:11px;" id="iexturdom" class="form-select form-select-sm" ${ requestScope.xempxturno.iextipturno=='1' ? 'enabled' : 'disabled'} disabled >
                                                                       <option value="-1">-- --</option>
                                                                       <c:forEach  var="LstTurno" items="${LstTurno}">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="col-md-12 col-sm-6 mt-2">
                                                        <button name="btn_actualizar_tipo_turno" id="btn_actualizar_tipo_turno" class="btn btn-primary btn-sm disabled " type="submit" onclick="updtipturno();"><span class="fa-solid fa-business-time me-2"></span>Grabar horario</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                               ...
                                               <tr>
                                                   <td>
                                                        <div class="col-8">
                                                            ...
                                                            <button name="btn_xls" class="btn btn-phoenix-success btn-sm mt-2 mb-2 disabled " onclick="enviaForm('6')">Exportar excel</button>
                                                        </div>
                                                   </td>
                                               </tr>
                                               <tr>
