                      ...
                      <div class="content2">
                          ...
                          <div class="mb-9">
                            <div class="row g-3 mb-4">
                              <div class="col-auto">
                                <h2 id="h2top" class="mb-0">Nuevo derecho habiente</h2>
                              </div>
                            </div>
                            ...
                            <div class="row g-3">
                                 <div class="col-xl-12">
                                   <form class="mb-0 needs-validation" method="POST" action="insertarDerechoHab" novalidate >
                                            ...
                                            <div class="card mb-3 shadow-sm">
                                              <div class="card-header bg-light border-bottom">
                                                <h5 class="mb-0 text-primary"><i class="fas fa-id-card me-2"></i>Datos personales</h5>
                                              </div>
                                              <div class="card-body">
                                                <div class="row g-3">
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Tipo de documento</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Nro doc</label>
                                                      <input class="form-control" name="iexnroiddep" maxlength="15" type="text" placeholder="Ingrese número documento" required/>
                                                  </div>
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">País emisor</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-6">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Apellido paterno</label>
                                                      <input class="form-control" name="iexapepatdep" maxlength="100" type="text" placeholder="Reynoso" required />
                                                  </div>
                                                  <div class="col-sm-6 col-md-6">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Apellido materno</label>
                                                      <input class="form-control" name="iexapematdep" maxlength="100" type="text" placeholder="Dominguez" required />
                                                  </div>
                                                  <div class="col-sm-6 col-md-12">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Nombres</label>
                                                      <input class="form-control" name="iexnomdep" maxlength="100" type="text" placeholder="Alberto Gabriel" required />
                                                  </div>

                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Fecha de nacimiento</label><span class="uil uil-calendar-alt flatpickr-icon text-700"></span>
                                                  ...
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Sexo</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Vínculo</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-6">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Tipo documento acredito vínculo</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Nro de doc acredito vínculo</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-3">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Mes de concepción</label>
                                                      <input class="form-control" name="iexmesconcep" maxlength="50" type="text" placeholder="Ingrese mes" />
                                                  </div>
                                                  <div class="col-sm-6 col-md-3">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Larga distancia</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-5">
                                                       <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Número de telefono</label>
                                                       <input class="form-control" name="iexnrotelf" maxlength="50" type="text" placeholder="987 893556" />
                                                  </div>
                                                  <div class="col-sm-6 col-md-6">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Email</label>
                                            ...
                                            <div class="card mb-3 shadow-sm">
                                              <div class="card-header bg-light border-bottom">
                                                <h5 class="mb-0 text-primary"><i class="fas fa-map-marker-alt me-2"></i>Dirección principal</h5>
                                              </div>
                                              <div class="card-body">
                                                <div class="row g-3">
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Tipo de via 1</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-8">
                                                       <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Referencia 1</label>
                                                       <input class="form-control" name="iexreferencia_dom1" maxlength="200" type="text" placeholder="Ingrese una referencia" required/>
                                                  </div>
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">País emisor 1</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Departamento 1</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Provincia 1</label>
                                                      <select class="form-select" name="iexprovin_origen1" id="iexprovin_origen1">
                                                        <option value="" selected >Seleccionar provincia</option>
                                                      </select>
                                                  </div>
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Distrito 1</label>
                                            ...
                                            <div class="card mb-3 shadow-sm">
                                              <div class="card-header bg-light border-bottom">
                                                <h5 class="mb-0 text-primary"><i class="fas fa-map-marker-alt me-2"></i>Dirección secundaria</h5>
                                              </div>
                                              <div class="card-body">
                                                <div class="row g-3">
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Tipo via 2</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-8">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Referencia 2</label>
                                                      <input class="form-control" name="iexreferencia_dom2" maxlength="150" type="text" placeholder="Ingrese una referencia"/>
                                                  </div>
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">País emisor 2</label>
                                                  ...
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Departamento 2</label>
                                                      <select class="form-select" name="iexdepart_origen2" id="iexdepart_origen2">
                                                        <option value="" selected >Seleccionar departamento</option>
                                                      </select>
                                                  </div>
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Provincia 2</label>
                                                      <select class="form-select" name="iexprovin_origen2" id="iexprovin_origen2">
                                                        <option value="" selected >Seleccionar provincia</option>
                                                      </select>
                                                  </div>
                                                  <div class="col-sm-6 col-md-4">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Distrito 2</label>
                                            ...
                                            <div class="card mb-3 shadow-sm">
                                              <div class="card-header bg-light border-bottom">
                                                <h5 class="mb-0 text-primary"><i class="fas fa-home me-2"></i>Domicilio</h5>
                                              </div>
                                              <div class="card-body">
                                                <div class="row g-3">
                                                  <div class="col-sm-6 col-md-6">
                                                      <label class="form-label fs-0 text-1000 ps-0 text-none mb-1">Domicilio</label>
                                                  ...
                                                  <div id="alert" class="alert alert-outline-success bg-success bg-opacity-10 d-flex align-items-center" role="alert" style="display:none !important;">
                                                      ...
                                                      <p class="mb-0 fw-semi-bold text-1000 flex-grow-1">Se grabó exitosamente los cambios</p>
                                            ...
                                            <div class="card shadow-sm mb-3">
                                              <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div>
                                                        <a class="btn btn-outline-secondary me-2" href="derechoHab@${idTrab}">
                                                            <i class="fas fa-times me-2"></i>Cancelar
                                                        </a>
                                                        <button class="btn btn-primary px-4" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal">
                                                            <i class="fas fa-save me-2"></i>Guardar derecho hab
                                                        </button>
                                                    </div>
                                                </div>
                                              </div>
                                              ...
                                              <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow">
                                                  ...
                                                  <div class="modal-body text-center py-4">
                                                    ...
                                                    <p class="text-muted small mb-0">Esta acción guardará el derecho habiente</p>
                                                  </div>
                                                  <div class="modal-footer border-0 justify-content-center pb-4">
                                                    <button class="btn btn-outline-secondary px-4" type="button" data-bs-dismiss="modal">Cancelar</button>
                                                    <button class="btn btn-primary px-5" onclick="mostrarAlert();" type="submit" data-bs-dismiss="modal">Confirmar</button>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
