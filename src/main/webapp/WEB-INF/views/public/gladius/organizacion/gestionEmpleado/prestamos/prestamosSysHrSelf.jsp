                            ...
                            <div class="mb-8">
                                <div>
                                  ...
                                  <div class="col-12 mt-4 mb-2 d-flex justify-content-end">
                                      ...
                                      <a class="btn btn-primary btn-sm ms-1 disabled" href="nuevoPrestamo@${idTrab}"><span class="fa-solid fa-plus me-2"></span>Add préstamo</a>
                                  </div>
                                </div>
                                      ...
                                      <tbody class="list" id="customer-order-table-body">
                                        <c:forEach var="LstPrestCab" items="${requestScope.LstPrestCab}">
                                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                              ...
                                              <td class="date align-middle white-space-nowrap fs--1 fw-bold text-1000 text-end pe-4">${LstPrestCab.ieximptotal}</td>
