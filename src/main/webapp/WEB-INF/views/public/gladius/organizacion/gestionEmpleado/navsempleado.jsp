...
<div id="otropciones" class="email-content scrollbar-overlay bg-white rounded-3 ps-3 pe-3 pt-2 border border-200">
  <div id="memnuborder" class="d-flex justify-content-between align-items-center">
  ...
  <ul class="nav flex-column border-0 fs--1 vertical-nav mb-4">
    <li class="nav-item mt-1" id="linav"><a id="detalleEmpl" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="detalleEmpl@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav"><a id="sueldoFijo" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="sueldoFijo@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav"><a id="sueldoVariable" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="sueldoVariable@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav"><a id="vacaciones" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="vacaciones@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav">
        <a id="ausentismo" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="ausentismo@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav">
        <a id="contrato" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="contrato@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav">
        <a id="derechoHab" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="derechoHab@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav">
        <a id="retencionJud" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="retencionJud@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav">
        <a id="prestamos" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="prestamos@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav">
        <a id="acumulado" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="acumulado@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav">
        <a id="gestionTiempo" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="gestionTiempo@${idTrab}">
    ...
    <li class="nav-item mt-1" id="linav">
        <a id="legajo" class="nav-link py-2 ps-0 pe-3 pt-1 pb-1 text-start outline-none" aria-current="page" href="legajo@${idTrab}">
