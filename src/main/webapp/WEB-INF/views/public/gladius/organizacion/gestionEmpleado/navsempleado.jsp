...
<div id="otropciones" class="email-content scrollbar-overlay">
  ...
  <ul class="nav flex-column border-top fs--1 vertical-nav mb-4">
    <li class="nav-item" id="linav"><a id="detalleEmpl" class="nav-link py-2 ps-0 pe-3 border-end border-bottom text-start outline-none" aria-current="page" href="detalleEmpl@${idTrab}">
    ...
    <li class="nav-item" id="linav"><a id="sueldoFijo" class="nav-link py-2 ps-0 pe-3 border-end border-bottom text-start outline-none" aria-current="page" href="sueldoFijo@${idTrab}">
    ...
    <li class="nav-item" id="linav"><a id="sueldoVariable" class="nav-link py-2 ps-0 pe-3 border-end border-bottom text-start outline-none" aria-current="page" href="sueldoVariable@${idTrab}">
    ...
    <li class="nav-item" id="linav"><a id="vacaciones" class="nav-link py-2 ps-0 pe-3 border-end border-bottom text-start outline-none" aria-current="page" href="vacaciones@${idTrab}">
