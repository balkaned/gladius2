                      ...
                      <div class="content2">
                          ...
                          <div class="mb-9">
                            <div class="row g-3 mb-4">
                              <div class="col-auto">
                                <h2 id="h2top" class="mb-0">Editar derecho habiente</h2>
                              </div>
                            </div>
                            <c:if test="${msg!=null}">
                                   ...
                                   <div class="row gx-3 gy-4">
                                     <form class="row g-3 mb-0 needs-validation" method="POST" action="modificarDerechoHab" novalidate >
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                ...
                                                <input class="form-control" name="iexnrodocacredit" maxlength="15" type="text" value="${requestScope.derhabx.iexnrodocacredit}" required placeholder="Ingrese numero doc acredito" required disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">Mes de concepción</label>
                                                <input class="form-control" name="iexmesconcep" maxlength="50" type="text" value="${requestScope.derhabx.iexmesconcep}" placeholder="Ingrese mes" disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                 ...
                                                 <input class="form-control" name="iexnrotelf" maxlength="50" type="text" value="${requestScope.derhabx.iexnrotelf}" placeholder="987 893556" disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">Email</label>
                                                <input class="form-control" name="iexemail" maxlength="50" type="text" value="${requestScope.derhabx.iexemail}" placeholder="Ingrese su correo" disabled />
                                            </div>
                                            <hr/>
                                            <div class="col-sm-6 col-md-4">
                                            ...
                                            <div class="col-sm-6 col-md-3">
                                                ...
                                                <input class="form-control" name="iexnrovia_dom1" maxlength="5" type="text" value="${requestScope.derhabx.iexnrovia_dom1}" placeholder="435" required disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                 ...
                                                 <input class="form-control" name="iexreferencia_dom1" maxlength="200" type="text" value="${requestScope.derhabx.iexreferencia_dom1}" placeholder="Ingrese una referencia" required disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-4">
                                            ...
                                            <div class="col-sm-6 col-md-12">
                                                ...
                                                <input class="form-control" name="iexnomvia_dom2" maxlength="20" value="${requestScope.derhabx.iexnomvia_dom2}" type="text" placeholder="Ingrese el nombre de la vía" disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                ...
                                                <input class="form-control" name="iexreferencia_dom2" maxlength="150" type="text" placeholder="Ingrese una referencia" disabled />
                                            </div>
                                            <div class="col-sm-6 col-md-4">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">País emisor 2</label>
                                                <select class="form-select" name="iexpaisemisor2" id="iexpaisemisor2" disabled >
