          ...
          <div class="content bg-100">
            ...
            <div class="mb-9">
              <div class="row g-3 mb-4">
                <div class="col-auto">
                  <h2 id="h2top" class="mb-0">Locales</h2>
                </div>
              </div>
                  ...
                  <div class="table-responsive scrollbar mx-n1 px-1">
                    <table class="table table-sm fs--1 mb-0">
                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="local" items="${requestScope.localesList}">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="total align-middle text-start fs-9">${local.iexubides}</td>
                              <td class="align-middle text-center white-space-nowrap pe-0 action">
                                 <div class="font-sans-serif btn-reveal-trigger position-static">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-end py-2">
                                     <a id="dropdownmenutable" class="dropdown-item" href="editarLocal@${local.iexubicod}"><span class="fa-solid fa-pencil me-2"></span>Editar</a>
                                     <div class="dropdown-divider"></div>
                                     <a id="dropdownmenutable" class="dropdown-item" onclick="return remove();" href="eliminarLocal@${local.iexubicod}"><span class="fa-solid fa-trash me-2"></span>Eliminar</a>
                                   </div>
                                 </div>
                               </td>
                            </tr>
