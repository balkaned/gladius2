                                   ...
                                   <div class="row gx-3 gy-4">
                                     <form class="row g-4 mb-0 needs-validation" method="POST" action="insertarPrestamo" novalidate >
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <input class="form-control" name="ieximpbruto" maxlength="10" type="number" value="${requestScope.xPrestCab.ieximpbru}" required />
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none">Nro Cuotas</label>
                                                <input class="form-control" name="iexnrocuota" maxlength="2" type="text" value="${requestScope.xPrestCab.iexnrocuotas}" required />
                                            </div>
                                            <div class="col-sm-6 col-md-12">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                 ...
                                                 <input class="form-control" name="iexinteres" maxlength="4" value="${requestScope.xPrestCab.iexinteres}" type="text" required placeholder="%"/>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none">Importe Total</label>
                                                <input class="form-control" name="ieximptotal" maxlength="15" value="${requestScope.xPrestCab.ieximptotal}" type="number" required />
                                            </div>
                                            <div class="col-sm-6 col-md-12">
                                                <label class="form-label fs-0 text-1000 ps-0 text-none">Glosa</label>
                                                <input class="form-control" name="iexglosa" maxlength="50" value="${requestScope.xPrestCab.iexglosa}" type="text" />
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <input class="form-control datetimepicker" name="iexfecpres" id="iexfecpres" value="${requestScope.xPrestCab.iexfecpres}" onchange="formatearFecha1();" type="text" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required />
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                  ...
                                                  <input class="form-control datetimepicker" name="iexfecinivig" id="iexfecinivig" value="${requestScope.xPrestCab.iexfecinivig}" onchange="formatearFecha2();" type="text" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required />
                                            </div>
                                            <div class="col-sm-6 col-md-12">
                            		  ...
                            		  <tbody class="list" id="customer-order-table-body">
                            			<c:forEach var="xPrestDet" items="${requestScope.xPrestDet}">
                            				<tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            				  ...
                            				  <td class="align-middle text-start fw-semi-bold ps-3 pe-3 text-1000"><span class="badge badge-phoenix fs--2 badge-phoenix-warning"><span class="badge-label">${xPrestDet.iexfecpre}</span></td>
