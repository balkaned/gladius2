                                      ...
                                      <tbody class="list" id="customer-order-table-body">
                                        <c:forEach var="LstPrestCab" items="${requestScope.LstPrestCab}">
                                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                              ...
                                              <td class="total align-middle text-start fw-semi-bold pe-20 text-1000"><span class="badge badge-phoenix fs--2 badge-phoenix-warning"><span class="badge-label">${LstPrestCab.destippres}</span></td>
                                              ...
                                              <td class="align-middle white-space-nowrap text-center text-700"><span class="badge badge-phoenix fs--4 badge-phoenix-info"><span class="badge-label">${LstPrestCab.iexinteres} %</span></td>
