                    ...
                    <table class="table table-sm fs--1 mb-0">
                      <thead>
                        <tr >
                          ...
                          <th class="sort align-middle text-center pe-0" scope="col" data-sort="date">AREA</th>
                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="area" items="${requestScope.areasList}">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="total align-middle text-start fw-semi-bold text-1000">${area.iexdesarea_descripcion}</td>
                              ...
                              <td class="align-middle text-end white-space-nowrap pe-0 action">
                                <div class="font-sans-serif btn-reveal-trigger position-static">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a id="dropdownmenutable" class="dropdown-item" href="editarArea@${area.iexcodarea}"><span class="fa-solid fa-pencil me-2"></span>Editar</a>
                                        <div class="dropdown-divider"></div>
                                        <a id="dropdownmenutable" class="dropdown-item" onclick="return remove();" href="deleteArea@${area.iexcodarea}"><span class="fa-solid fa-trash me-2"></span>Eliminar</a>
                                   </div>
                                </div>
                              </td>
                            </tr>
