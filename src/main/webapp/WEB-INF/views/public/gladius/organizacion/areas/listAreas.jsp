            ...
            <div class="mb-4">
              <div class="row g-3">
                ...
                <div class="col-auto">
                  ...
                  <button class="btn btn-primary"><span class="fas fa-plus me-2"></span>Add new Area</button>
                </div>
              </div>
            </div>
                ...
                <table class="table table-sm fs--1 mb-0">
                  <thead>
                    <tr >
                      ...
                      <th class="sort align-middle text-end pe-0" scope="col" data-sort="date">AREA</th>
                      <th class="sort align-middle text-end pe-0" scope="col" data-sort="date">DESCRIPCION</th>
                      <th class="sort align-middle ps-8" scope="col" data-sort="date">CATEGORIA</th>
                      <th class="sort align-middle text-end pe-0" scope="col" data-sort="date">AREA PADRE</th>
                  ...
                  <tbody class="list" id="order-table-body">
                      <c:forEach var="area" items="${requestScope.areasList}">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          ...
                          <td class="total align-middle text-end fw-semi-bold text-1000">${area.iexdesarea_descripcion}</td>
                          <td class="total align-middle text-end fw-semi-bold text-1000">${area.iexdesarea}</td>
                          <td class="total align-middle text-end fw-semi-bold text-1000">${area.descodcat}</td>
