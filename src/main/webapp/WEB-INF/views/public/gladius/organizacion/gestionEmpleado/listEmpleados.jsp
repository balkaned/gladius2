              ...
              <div id="orderTable" data-list='{"valueNames":["order","total","customer","payment_status","fulfilment_status","delivery_type","date"],"page":10,"pagination":true}'>
                <div class="mb-4">
                  <div class="row g-3">
                    ...
                    <div class="col-auto">
                      <a class="btn btn-link text-900 me-4 px-0" href="AWSorFTP_flgsource@verReporteExcel@${idComp}@null@null@null@PadronTrabajadores" target="_blank" ><span class="fa-solid fa-file-export fs--1 me-2"></span>Descargar Todos Xls</a>
                              ...
                              <td class="align-middle text-end white-space-nowrap pe-0 action">
                                 <div class="font-sans-serif btn-reveal-trigger position-static">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-end py-2">
                                        ...
                                        <a class="dropdown-item" href="AWSorFTP_flgsource@verReportePDF@${idComp}@${empl.iexcodtra}@null@null@FichaTrabajador" target="_blank"><span class="fa-solid fa-file-pdf fs--1 me-2"></span>Descargar Ficha PDF</a>
