                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="empl" items="${requestScope.empleadoList}">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="fulfilment_status align-middle white-space-nowrap text-center fw-bold text-700"><span class="badge badge-phoenix fs--2 badge-phoenix-warning"><span class="badge-label">${empl.destiptra}</span><span class="ms-1" data-feather="" style="height:12.8px;width:12.8px;"></span></span></td>
