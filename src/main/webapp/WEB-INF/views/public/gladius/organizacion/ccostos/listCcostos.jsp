          ...
          <div class="content">
            <nav class="mb-2" aria-label="breadcrumb">
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Centro Costos</li>
              </ol>
            </nav>
            <div class="mb-9">
                ...
                <div class="mb-4">
                  <div class="row g-3">
                    ...
                    <div class="col-auto">
                      ...
                      <a class="btn btn-primary" href="nuevoCcosto"><span class="fas fa-plus me-2"></span>Add C. Costo</a>
                    </div>
                  </div>
                </div>
                    ...
                    <table class="table table-sm fs--1 mb-0">
                      <thead>
                        <tr >
                          ...
                          <th class="sort align-middle text-center pe-0" scope="col" data-sort="date">CENTRO COSTO</th>
                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="cc" items="${requestScope.ccostosList}">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="total align-middle text-center fw-semi-bold text-1000">${cc.iexdesccosto}</td>
                              <td class="total align-middle text-center fw-semi-bold text-1000"><span class="badge badge-phoenix fs--1 badge-phoenix-secondary"><span class="badge-label">${cc.descodcat}</span</td>
                              ...
                              <td class="align-middle text-end white-space-nowrap pe-0 action">
                                 <div class="font-sans-serif btn-reveal-trigger position-static">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a id="dropdownmenutable" class="dropdown-item" href="editarCcosto@${cc.iexccosto}"><span class="fa-solid fa-pencil me-2"></span>Editar</a>
                                        <div class="dropdown-divider"></div>
                                        <a id="dropdownmenutable" class="dropdown-item" onclick="return remove();" href="deleteCcosto@${cc.iexccosto}"><span class="fa-solid fa-trash me-2"></span>Eliminar</a>
                                   </div>
                                 </div>
                              </td>
                            </tr>
