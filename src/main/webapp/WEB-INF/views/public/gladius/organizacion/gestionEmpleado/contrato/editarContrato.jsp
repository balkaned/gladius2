                      ...
                      <div class="content2">
                          ...
                          <div class="mb-9">
                            <div class="row g-3 mb-4">
                              <div class="col-auto">
                                <h2 id="h2top" class="mb-0">Editar contrato</h2>
                              </div>
                            </div>
                            ...
                            <div class="row g-3">
                                 <div class="col-xl-9">
                                   <div class="row gx-3 gy-4">
                                     <form class="row g-3 mb-0 needs-validation" method="POST" action="modificarContrato" novalidate >
                                            <input class="form-control" name="iexcodcia" type="hidden" value="${requestScope.emp.iexcodcia}" />
                                            <input class="form-control" name="iexcodtra" type="hidden" value="${requestScope.emp.iexcodtra}" />

                                            <div class="col-sm-6 col-md-2">
                                                  <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">Id</label>
                                                  <input class="form-control" name="iexcorrel" id="iexcorrel" type="text" value="${iexcorrel}" required disabled />
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                  ...
                                                  <input class="form-control datetimepicker" name="iexfecini" id="iexfecini" value="${requestScope.xContratoEmp.iexfecini}" onchange="formatearFecha1();" type="text" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required />
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                  ...
                                                  <input class="form-control datetimepicker" name="iexfecfin" id="iexfecfin" value="${requestScope.xContratoEmp.iexfecfin}" onchange="formatearFecha2();" type="text" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required />
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <select class="form-select" name="iexmodcont" required >
                                                  <option value="" selected >Seleccionar modelo contrato</option>
