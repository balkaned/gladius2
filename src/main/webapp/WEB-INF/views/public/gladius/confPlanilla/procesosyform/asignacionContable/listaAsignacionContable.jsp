	...
	<div class="content">
		<nav class="mb-2" aria-label="breadcrumb">
			<ol class="breadcrumb mb-0">
				...
				<li class="breadcrumb-item active">Asig. contable</li>
			</ol>
		</nav>
		<div class="mb-3">
			<div class="row g-3 mb-4">
				<div class="col-auto">
					<h2 id="h2top" class="mb-0">Asignación contable</h2>
				</div>
			</div>
		</div>
		<div class="row g-5">
                        ...
                        <div class="row gx-3 gy-4">
                            <form class="row g-4 mb-0 needs-validation" method="POST" action="" novalidate>
                                ...
                                <div class="d-grid gap-2 d-md-block">
                                    ...
                                    <a class="btn btn-phoenix-primary" href="#"><span class="fas fa-plus me-2"></span>Add Asig. contable</a>
								...
								<td class="align-middle text-center white-space-nowrap pe-0 action">
									<div class="font-sans-serif btn-reveal-trigger position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
											<a id="dropdownmenutable" class="dropdown-item" href="#!"><span class="fa-solid fa-pencil me-2"></span>Editar</a></div>
