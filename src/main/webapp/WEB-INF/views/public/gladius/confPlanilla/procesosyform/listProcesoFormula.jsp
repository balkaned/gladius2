                ...
                <td class="align-middle text-center white-space-nowrap pe-0 action">
                  <div class="font-sans-serif btn-reveal-trigger position-static">
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-2">
                      <a class="dropdown-item text-warning" href="planillaEmpleados">Conceptos</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item text-warning" href="listFormulas">Formulas</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item text-warning" href="#!">Periodos</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item text-warning" href="#!">Asig. Contable</a>
                      <div class="dropdown-divider"></div>
