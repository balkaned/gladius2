          ...
          <table class="table table-sm fs--1 mb-0">
            <thead>
                <tr>
                  ...
                  <th class="sort align-middle text-center pe-0 ps-0 white-space-nowrap" scope="col" data-sort="concept">CONCEPTO</th>
                  <th class="sort align-middle text-center pe-0 ps-0 white-space-nowrap" scope="col" data-sort="var">VARIABLE FORMULA</th>
                  <th class="sort align-middle text-center pe-0" scope="col" data-sort="des">DESCRIPCION</th>
                  <th class="sort align-middle text-center pe-0" scope="col" data-sort="abr">ABREVIADO</th>
