                 ...
                 success: function (data) {
                      ...
                      for (var i in data) {
                           opt += "<tr class='hover-actions-trigger btn-reveal-trigger position-static'>"+
                                      ...
                                      "<td class='concept align-middle text-start ps-5 fw-semi-bold text-1000'><span class='badge badge-phoenix fs--2 badge-phoenix-secondary'>"+data[i].coodescon+"</span></td>"+
                      ...
                      <div class="mb-3">
                        <div class="row g-3">
                            ...
                            <form class="mb-0 needs-validation" method="POST" action="buscarConceptoProceso" novalidate>
                                ...
                                <div class="mt-2 mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white border-top border-bottom border-200 position-relative top-1" data-list='{"valueNames":["id","concept"],"page":15, "pagination":true }'>
                                    <div class="table-responsive scrollbar mx-n1 px-1">
                                        <table class="table table-sm fs--1 mb-0">
                                            ...
                                            <tbody class="list" id="customer-order-table-body">
                                                <c:forEach var="conceptoXProcesoList" items="${requestScope.conceptoXProcesoList}">
                                                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                    ...
                                                    <td class="align-middle text-center white-space-nowrap pe-0 action">
                                                      <div class="font-sans-serif btn-reveal-trigger position-static">
                                                        ...
                                                        <span class="fas fa-plus"></span><span class="fas fa-caret-down ms-2"></span></button>
                                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                                          <a id="dropdownmenutable" class="dropdown-item" href="editarConceptoXProceso@${proceso}@${conceptoXProcesoList.procodcon}"><span class="fa-solid fa-pencil me-2"></span>Editar</a>
                                                          <div class="dropdown-divider"></div>
                                                          <a id="dropdownmenutable" class="dropdown-item" onclick="return remove();" href="deleteConceptoXProceso@${proceso}@${conceptoXProcesoList.procodcon}"><span class="fa-solid fa-trash me-2"></span>Eliminar</a></div>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                </c:forEach>
