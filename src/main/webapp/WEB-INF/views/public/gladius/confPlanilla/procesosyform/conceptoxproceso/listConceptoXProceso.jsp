            ...
            <div class="content">
                ...
                <div id="orderTable" data-list='{"valueNames":["id","concept"],"page":15,"pagination":true}'>
                    <form class="mb-0 needs-validation" method="POST" action="buscarConceptoProceso" novalidate>
                        ...
                        <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white border-top border-bottom border-200 position-relative top-1" data-list='{"valueNames":["id","concept"],"page":15, "pagination":true }'>
