                    ...
                    <div class="row gx-3 gy-4">
                      <form class="row g-4 mb-0 needs-validation" method="POST" action="" novalidate>
                        ...
                        <div class="col-sm-6 col-md-6">
                          ...
                          <input class="form-control datetimepicker" name="" id="" onchange="formatearFecha1();"
                            type="text" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' />
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-block">
                                              <button class="btn btn-primary" type="submit" data-bs-toggle="modal" data-bs-target="#confirmModal" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><svg class="svg-inline--fa fa-magnifying-glass me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="magnifying-glass" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M500.3 443.7l-119.7-119.7c27.22-40.41 40.65-90.9 33.46-144.7C401.8 87.79 326.8 13.32 235.2 1.723C99.01-15.51-15.51 99.01 1.724 235.2c11.6 91.64 86.08 166.7 177.6 178.9c53.8 7.189 104.3-6.236 144.7-33.46l119.7 119.7c15.62 15.62 40.95 15.62 56.57 0C515.9 484.7 515.9 459.3 500.3 443.7zM79.1 208c0-70.58 57.42-128 128-128s128 57.42 128 128c0 70.58-57.42 128-128 128S79.1 278.6 79.1 208z"></path></svg><!-- <span class="fa-solid fas fa-search me-2"></span> Font Awesome fontawesome.com -->Buscar</button>
                                             <a class="btn btn-primary" href="nuevoGestionVacaciones"><svg class="svg-inline--fa fa-plus me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M432 256c0 17.69-14.33 32.01-32 32.01H256v144c0 17.69-14.33 31.99-32 31.99s-32-14.3-32-31.99v-144H48c-17.67 0-32-14.32-32-32.01s14.33-31.99 32-31.99H192v-144c0-17.69 14.33-32.01 32-32.01s32 14.32 32 32.01v144h144C417.7 224 432 238.3 432 256z"></path></svg><!-- <span class="fas fa-plus me-2"></span> Font Awesome fontawesome.com -->Agregar</a>
                              ...
                              <div class="table-responsive scrollbar mx-n1 px-1">
                                <table class="table table-sm fs--1 mb-0">
                                  <thead>
                                    <tr>
                                      <th class="white-space-nowrap fs--1 align-middle ps-0" style="width:26px;">
                                        <div class="form-check mb-0 fs-0">
                                          <input class="form-check-input" id="checkbox-bulk-order-select"
                                            type="checkbox" data-bulk-select='{"body":"order-table-body"}' />
                                        </div>
                                      </th>
                                      <th class="sort white-space-nowrap align-middle pe-3" scope="col"
                                        data-sort="order" style="width:5%;">ID</th>
                                      ...
                                      <th class="sort align-middle text-center ps-5 pe-5" scope="col" data-sort="date">
                                        F. ingreso</th>
                                      <th class="sort align-middle text-start pe-0" scope="col" data-sort="date">Tipo Vaca.</th>
                                      <th class="sort align-middle text-center ps-5 pe-5" scope="col" data-sort="date">
                                        ESTADO</th>
                                  ...
                                  <tbody class="list" id="order-table-body">
                                      ...
                                      <c:forEach var="list" items="${requestScope.listVacaciones}">

                             <tr>
                                                                                      <td><a href="#" onclick="modificarDet('${LstVacacionesView.iexcodtra}','${LstVacacionesView.iexcorrel}')"  > ${list.iexcorrel} </a> </td>
                                                                                      <td>${list.nrodoc}</td>
                                                                                      <td>${list.iexcodtra}</td>
                                                                                      <td>${list.desnomtra}</td>
                                                                                      <td>${list.desestado}</td>
                                                                                      <td>${list.fecing}</td>
                                                                                      <td>${list.destipvac}</td>
                                                                                      <td>${list.iexfecini}</td>
                                                                                      <td>${list.fecfinrep}</td>
                                                                                      <td>${list.iexnrodias}</td>
