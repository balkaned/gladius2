                  ...
                  <div class="mb-4">
                    <div class="row g-3">
                      ...
                      <div class="col-auto">
                        ...
                        <a class="btn btn-primary" href="nuevoTurno"><span class="fas fa-plus me-2"></span>Add Turno</a>
                      </div>
                    </div>
                  </div>
                  <div
                      ...
                      <table class="table table-sm fs--1 mb-0">
                        <thead>
                          <tr>
                            ...
                            <th class="sort align-middle text-center ps-8" scope="col" data-sort="date">AHORA INICIO
                            </th>
                        ...
                        <tbody class="list" id="order-table-body">
                          <c:forEach var="turn" items="${requestScope.turnoList}">
