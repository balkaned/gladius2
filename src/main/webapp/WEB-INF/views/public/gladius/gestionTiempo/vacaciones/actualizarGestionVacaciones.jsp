                      ...
                      <form class="row g-4 mb-0 needs-validation" name="formvacaciones" id="formvacaciones"  method="POST" action="actualizarGestionVacaciones" novalidate>
                        ...
                        <div class="col-sm-6 col-md-6">
                         ...
                         <div class="col-sm-6 col-md-6">
                           ...
                           <input type="text" name="iexcorrel" value="${requestScope.xVacacionesPrg.iexcorrel}"  class="form-control"   readonly="true" style="background-color:#F1F4F8;" >
                             </select>
                          </div>
                        <div class="col-sm-6 col-md-6">
                        ...
                        <div class="col-sm-6 col-md-3">
                          <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">Saldo Dias</label>
                            <input type="text" name="iexsaldodias"  class="form-control"  id="iexsaldodias" value="${requestScope.xSaldo}" readonly="true" style="background-color:#F1F4F8;">
                        </div>
                        <div class="col-sm-6 col-md-3">
                        ...
                        <div class="col-sm-6 col-md-3">
                          <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">Numero Dias</label>
                            <input type="text" name="iexnrodias"  class="form-control"    id="iexnrodias"  value="${requestScope.xVacacionesPrg.iexnrodias}" readonly="true" style="background-color:#F1F4F8;">
                        </div>
                          ...
                          <div class="row g-3 justify-content-end">
                            ...
                            <div class="col-auto">
                              <button class="btn btn-primary px-5 px-sm-9" type="button" data-bs-toggle="modal"
                                ...
                                aria-expanded="false" data-bs-reference="parent">Actualizar Vacaciones</button>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border">
                              ...
                              <div
                                ...
                                <button class="btn btn-sm btn-primary px-9 fs--2 my-0" onclick="actualizarGestionVacaciones();" type="submit" data-bs-dismiss="modal" >Confirmar</button>
                              </div>
                            </div>
                          </div>
                        </div>
