              ...
              <div class="row g-3">
                 <div class="col-xl-12">
                   <div class="row gx-3 gy-4">
                      <form id="formVariable" class="row g-3 mb-0 needs-validation" method="POST" action="gestionarPlanLiq" novalidate >
                        ...
                        <div class="col-sm-6 col-md-4">
                            ...
                            <input class="form-control" name="txtobservacion" type="text" value="${LstPlanillaRes.iexobscese}" placeholder="Ingrese observación aqui" />
                        </div>
                        <div class="col-sm-6 col-md-2">
                        ...
                        <div class="col-sm-6 col-md-4">
                          ...
                          <select id="idxtipcese2" name="idxtipcese2" class="form-select" required>
                              <option value="" selected >Seleccionar</option>
                        ...
                        <div class="col-sm-6 col-md-2">
                          ...
                          <input class="form-control" name="txtImporte" maxlength="10" step=0.01 type="number" value="" placeholder="334.00" required/>
                        </div>
                        ...
                        <div class="col-12 gy-6">
                            <div class="col-12">
                                <a class="btn btn-phoenix-secondary btn-sm px-5 mt-1" href="listarDetallePlanillaGen@${codreg}@${codproceso}@${periodo}"><span class="fas fa-reply me-2"></span>Atras</a>
                                <a class="btn btn-phoenix-primary btn-sm mt-1" onclick="enviaForm('14')" href="#"><span class="fas fa-floppy-disk me-2"></span>Guardar datos</a>
                                <button class="btn btn-primary btn-sm mt-1" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" ><span class="fas fa-plus me-2"></span>Add variable</button>
                            </div>
                        </div>
                          ...
                          <table class="table table-sm fs--1 mb-0">
                            <thead>
                              <tr>
                                ...
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="id">ID COCNEPT</th>
