...
Author : Jan Quiroz Email : janquirozs@gmail.com --%>
                ...
                <div class="modal-body p-0">
                  ...
                  <div class="row mt-2 ps-3 pe-3 mb-2">
                      ...
                      <div class="col-sm-6 col-md-12 mt-2">
                            ...
                            <input class="form-control" name="idPeriodoCopy2" id="idPeriodoCopy2" type="text" maxlength="6" placeholder="Ingrese periodo: yyyymm" required />
                      </div>
                  </div>
                </div>
