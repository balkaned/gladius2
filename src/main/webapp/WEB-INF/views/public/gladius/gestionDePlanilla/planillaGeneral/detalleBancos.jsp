...
<html lang="en-US" dir="ltr">
  ...
  <script>
    function formatearFecha1(){
      var fechaSeleccionada = $('#fpago').val();
          ...
          <div class="content">
            <nav class="mb-2" aria-label="breadcrumb">
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Detalle Bancos</li>
              </ol>
            </nav>
            <div class="mb-12">
              <div class="row g-3 mb-2">
                <div class="col-auto">
                  <h2 id="h2top" class="mb-0">Detalle de bancos por planilla</h2>
                </div>
              </div>
                   ...
                   <div class="row gx-3 gy-4">
                      <form id="fmrBanks" class="row g-4 mb-0 needs-validation" method="POST" action="gestionarBankPlan" novalidate >
                        ...
                        <div class="col-sm-6 col-md-3">
                        	  ...
                        	  <input class="form-control datetimepicker" name="fpago" id="fpago" onchange="formatearFecha1();" type="text" value="${requestScope.xproplaper.iexfeccerti}" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true}' required />
                              <input class="form-control" id="fpagohidden" type="hidden" value="${requestScope.xproplaper.iexfeccerti}" />
                        </div>
                        ...
                        <div class="table-responsive scrollbar mx-n1 px-1">
                          <table class="table table-sm fs--1 mb-0">
                            ...
                            <tbody class="list" id="order-table-body">
                                <c:forEach var="xbankproper" items="${requestScope.xbankproper}">
