              ...
              <div class="row g-3">
                 <div class="col-xl-9">
                   <div class="row gx-3 gy-4">
                      <form class="row g-3 mb-0 needs-validation" method="POST" action="insertarTrabLiq" novalidate >
                        <input type="hidden" name="iexcodpro"  value="${codproceso}">
                        ...
                        <input type="hidden" name="iexcodreg"  value="${codreg}">
                      	...
                      	<div class="col-sm-6 col-md-7">
                        	  ...
                        	  <select name="idxtrabajador" class="form-select" required >
                        		  ...
                        		  <c:forEach var="lstEmpleado" items="${lstEmpleado}">
                        			  <option value="${lstEmpleado.iexcodtra}" >${lstEmpleado.iexapepat}  ${lstEmpleado.iexapemat} ${lstEmpleado.iexnomtra} - ${lstEmpleado.iexfecing}</option>
                        		  </c:forEach>
                        	  </select>
                        </div>
