                    ...
                    <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white border-top border-bottom border-200 position-relative top-1">
                        <div class="table-responsive scrollbar mx-n1 px-1">
                                                ...
                                                <div class="font-sans-serif btn-reveal-trigger position-static">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                                        <a id="dropdownmenutable" class="dropdown-item" target="_blank"
                                                           href="AWSorFTP_flgsource@verReportePDF@${idComp}@${Res_planilla5ta.iexcodtra}@null@null@BoletaEmpTra@3UP_CODPRO=${Res_planilla5ta.iexcodpro}UP_NROPER=${Res_planilla5ta.iexnroper}UP_CORREL=${Res_planilla5ta.iexcorrel}@null@null@null">
                                                           <span class="fa-solid fa-download me-2"></span>Boleta PDF</a>
                                                        <a id="dropdownmenutable" class="dropdown-item" target="_blank"
                                ...
                                <c:if test="${xtotingreso!=0}">
                                    <tfoot>
                                        <tr >
                                            ...
                                            <td class="total align-middle text-center "><h5><fmt:formatNumber value="${xrenta5taotrciames}" type="number" maxFractionDigits="2" pattern='###,###.00'/></h5></td>
                                            <td class="total align-middle text-center "><h5><fmt:formatNumber value="${xtotneto}" type="number" maxFractionDigits="2" pattern='###,###.00'/></h5></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                    </tfoot>
                            ...
                            <div>
                                ...
                                <c:if test="${xtotaniorem5ta!=0}">
                                    <h4 class="mt-4">Total ingresos afectos a 5ta del año : <span class="ms-3"><fmt:formatNumber value="${xtotaniorem5ta}" type="number" maxFractionDigits="2" pattern='###,###.00'/></span></h4>
                                    <p class="mt-2 mb-3">Total descuentos 5ta del año: <span class="ms-3"><fmt:formatNumber value="${xtotaniorent5ta}" type="number" maxFractionDigits="2" pattern='###,###.00'/></span></p>
                                </c:if>
                            </div>
                        </div>
        ...
        <div class="modal-content border">
            <form id="addEventForm" autocomplete="off">
                ...
                <div class="modal-body pt-4 pb-2 px-4">
                    <div class="ps-3" style="font-size:13px;"></div>
                </div>
