                ...
                <div class="col-xl-8">
                    <div class="row gx-3 gy-4">
                        <form class="row g-3 mb-0 needs-validation" method="POST" action="" novalidate>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary btn-sm" type="submit"><span class="fa-solid fa-plus me-2"></span>Add concepto</button>
                            </div>
                        </form>
                    </div>
                </div>
                                    ...
                                    <c:if test="${not empty requestScope.listacon}">
                                        <c:forEach var="listacon" items="${requestScope.listacon}">
                                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                ...
                                                <td class="order align-middle white-space-nowrap py-0">${listacon.codConcepto}</td>
                                                <td class="total align-middle text-center fw-semi-bold text-1000">${listacon.desConcepto}</td>
                                            </tr>
                                        </c:forEach>
                                    </c:if>
                                </tbody>
