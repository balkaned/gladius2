      ...
      <main class="main" id="top">
        ...
        <div class="content">
          ...
          <div class="mb-9">
            ...
            <div id="orderTable" class="mt-3"data-list='{"valueNames":["order","total","customer","payment_status","fulfilment_status","delivery_type","date"],"page":10,"pagination":true}'>
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="order"
                          style="width:5%;">ID</th>
                        <th class="sort align-middle text-center ps-5" scope="col" data-sort="date">ASIENTO
                        </th>
                        ...
                        <th class="sort align-middle text-center ps-5" scope="col" data-sort="date">
                          N°PERSONA</th>
                        <th class="sort align-middle text-center ps-5" scope="col" data-sort="date">PROCESO
                        </th>
                        ...
                        <th class="sort align-middle text-start pe-0" scope="col" data-sort="date">REP.XLS
                        </th>
                      </tr>
                    </thead>
                    <tbody class="list" id="order-table-body">
                      <c:forEach var="lst_asiento_cab" items="${requestScope.lst_asiento_cab}">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          ...
                          <td
                            ...
                            <c:if test="${lst_asiento_cab.estado=='inactivo'}">
                              <td
                                class="payment_status align-middle white-space-nowrap text-center fw-bold text-700">
                            ...
                            <td><input type="button"  name="Generar" value ="Generar"   class="btn btn-success dropdown-toggle"  ></td>
                            <td><input type="button"  name="Pdf" value ="Pdf"   class="btn btn-primary dropdown-toggle"    ></td>
                            <td><input type="button"  name="Xls" value ="Xls"  class="btn btn-danger dropdown-toggle dropdown-toggle-split"  ></td>
                        </tr>
                      </c:forEach>
                    </tbody>
                  </table>
