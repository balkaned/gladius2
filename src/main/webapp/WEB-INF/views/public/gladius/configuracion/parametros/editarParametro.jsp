                              ...
                              <div class="col-sm-6 col-md-12">
                                    ...
                                    <select class="form-select" name="iextippar" required>
                                      ...
                                      <c:forEach var="lovTippar" items="${lovTippar}">
                                          <option value="${lovTippar.idLov}" ${lovTippar.idLov== requestScope.xParametro.iextippar ? 'selected' : ''}>${lovTippar.desLov}</option>
                                      </c:forEach>
                                    </select>
                              </div>
                              <div class="col-sm-6 col-md-4">
                                     <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">Valor (*)</label>
                                     <input class="form-control" name="iexvalcon" type="number"  value="${requestScope.xParametro.iexvalcon}"/>
                              </div>
