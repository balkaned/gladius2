                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="LstRole" items="${requestScope.LstRole}">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="order align-middle white-space-nowrap py-0"><a class="fw-semi-bold" href="editarRol@${LstRole.idRole}">#${LstRole.idRole}</a></td>
                              <td class="total align-middle text-start fw-semi-bold text-1000 ps-5"><span class="badge badge-phoenix fs--2 badge-phoenix-info"><span class="badge-label">${LstRole.desRole}</span></td>
                              ...
                              <td class="align-middle text-end white-space-nowrap pe-0 action">
                                 <div class="font-sans-serif btn-reveal-trigger position-static">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a id="dropdownmenutable" class="dropdown-item" href="editarRol@${LstRole.idRole}"><span class="fa-solid fa-pencil me-2"></span>Editar</a>
