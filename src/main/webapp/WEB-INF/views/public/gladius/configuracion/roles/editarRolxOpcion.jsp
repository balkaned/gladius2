              ...
              <div class="row g-5">
                   <div class="col-xl-6">
                     <div class="row gx-3 gy-4">
                       <form class="row g-4 mb-0 needs-validation" method="POST" action="modificarRolxOpcion" novalidate >
                              ...
                              <div class="col-sm-6 col-md-12">
                              	  ...
                              	  <select name="iexcodopc" class="form-select" required >
                              		  ...
                              		  <c:forEach var="lovOpcion" items="${lovOpcion}">
                              			  <option value="${lovOpcion.iexcodopc}"  ${lovOpcion.iexcodopc== requestScope.exRolxopc.iexcodopc ? 'selected' : ''}>${lovOpcion.iexdesopc}</option>
                              		  </c:forEach>
                              	  </select>
                              </div>
                              ...
                              <div class="col-sm-6 col-md-6">
                                    ...
                                    <select name="iexflgest" class="form-select" required >
                                        <option value="1"   ${'1'== requestScope.exRolxopc.iexflgest ? 'selected' : ''}   >Si</option>
                                        <option value="0"    ${'0'== requestScope.exRolxopc.iexflgest ? 'selected' : ''}  >No</option>
                                    </select>
                              </div>
