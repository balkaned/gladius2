          ...
          <div class="content bg-100">
            ...
            <div class="mb-9">
              <div class="row g-3 mb-4">
                <div class="col-auto">
                  <h2 id="h2top" class="mb-0">Nuevo rol x opción</h2>
                </div>
              </div>
              ...
              <div class="row g-3">
                   <div class="col-xl-6">
                     <div class="row gx-3 gy-4">
                       <form class="row g-3 mb-0 needs-validation" method="POST" action="insertarRolxOpcion@${idRol}" novalidate >
                          <input name="iexcodrol" type="hidden" value="${idRol}" />
                          <div class="col-sm-6 col-md-3">
                                 <label class="form-label fs-0 text-1000 ps-0 text-none mb-2">Id</label>
                                 <input class="form-control" name="iexcodrol2" type="number" value="${idRol}" placeholder="#" required disabled />
                          </div>
