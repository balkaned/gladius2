                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="LstSistema" items="${requestScope.LstSistema}">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="total align-middle text-start fw-semi-bold text-1000 ps-5 pe-5"><span class="badge badge-phoenix fs--2 badge-phoenix-secondary"><span class="badge-label">${LstSistema.iexdessys}</span></td>
