          ...
          <div class="content">
            ...
            <div class="mb-9">
              <div class="row g-3 mb-4">
                <div class="col-auto">
                  <h2 id="h2top" class="mb-0">Opciones</h2>
                </div>
              </div>
              ...
              <div id="orderTable" data-list='{"valueNames":["order","total","customer","payment_status","fulfilment_status","delivery_type","date"],"page":10,"pagination":true}'>
                <div class="mb-4">
                  <div class="row g-3">
                    <div class="col-auto">
                      <div class="search-box">
                        <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                          <input class="form-control search-input search" type="search" placeholder="Search opciones" aria-label="Search" />
                    ...
                    <div class="col-auto">
                        <a class="btn btn-primary btn-sm" href="nuevaOpcion" ><span class="fas fa-plus me-2"></span>Add Opción</a>
                  ...
                  <div class="table-responsive scrollbar mx-n1 px-1">
                    <table class="table table-sm fs--1 mb-0">
                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="LstOpciones" items="${requestScope.LstOpciones}">
                              ...
                              <td class="align-middle text-end white-space-nowrap pe-0 action">
                                 <div class="font-sans-serif btn-reveal-trigger position-static">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a id="dropdownmenutable" class="dropdown-item" href="editarOpc@${LstOpciones.iexcodopc}"><span class="fa-solid fa-pencil me-2"></span>Editar</a>
                                        <div class="dropdown-divider"></div>
                                        <a id="dropdownmenutable" class="dropdown-item" onclick="return remove();" href="deleteOpc@${LstOpciones.iexcodopc}"><span class="fa-solid fa-trash me-2"></span>Eliminar</a>
                                   </div>
                                 </div>
                               </td>
                            </tr>
