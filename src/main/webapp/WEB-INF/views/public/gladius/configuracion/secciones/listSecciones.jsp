                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="LstSeccion" items="${requestScope.LstSeccion}">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="fulfilment_status align-middle white-space-nowrap text-start fs-9">${LstSeccion.iexsecurl}</td>
                              <td class="fulfilment_status align-middle white-space-nowrap text-start fs-9 ps-5">${LstSeccion.iexactiondef}</td>
                              <td class="fulfilment_status align-middle white-space-nowrap text-start fs-9 ps-5">${LstSeccion.iexsecobs}</td>
