                ...
                <div class="mb-4">
                  <div class="row g-3">
                    ...
                    <div class="col-auto">
                      ...
                      <a class="btn btn-primary" href="nuevoUsuario" ><span class="fas fa-plus me-2"></span>Add Usuario</a>
                    </div>
                  </div>
                </div>
                      ...
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="LstUsuario" items="${requestScope.LstUsuario}">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="order align-middle white-space-nowrap py-0"><a class="fw-semi-bold" href="#">#${LstUsuario.idUsuario}</a></td>
