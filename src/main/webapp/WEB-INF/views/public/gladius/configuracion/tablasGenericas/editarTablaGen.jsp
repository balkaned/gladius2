              ...
              <div class="row g-3">
                   <div class="col-xl-7">
                     <div class="row gx-3 gy-4">
                       <form class="row g-3 mb-0 needs-validation" method="POST" action="modificarTblGen" novalidate >
                              ...
                              <div class="col-sm-6 col-md-8">
                                    ...
                                    <input class="form-control" name="iexdesrol" type="text" value="${requestScope.ttablacx.iexdestab}" placeholder="Ingrese la descripción de la tabla" required/>
                              </div>
