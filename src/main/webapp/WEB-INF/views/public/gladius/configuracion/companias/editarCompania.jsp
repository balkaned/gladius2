                                ...
                                <div class="col-md-7 col-lg-9 col-xl-9">
                                    <div class="lead-details-container">
                                      <ul class="nav nav-underline deal-details scrollbar flex-nowrap w-100 pb-1 mb-2" id="myTab" role="tablist" style="overflow-y: hidden;">
                                        ...
                                        <li class="nav-item text-nowrap me-2" role="presentation">
                                            <a class="nav-link" id="notes-tab" data-bs-toggle="tab" href="#tab-notes" role="tab" aria-controls="tab-notes" aria-selected="false" tabindex="-1"><span class="fa-solid fa-plug cap me-2 tab-icon-color"></span>Datos de conexión</a>
                                        </li>
                                        <li class="nav-item text-nowrap me-2" role="presentation">
                                            <a class="nav-link" id="meeting-tab" data-bs-toggle="tab" href="#tab-meeting" role="tab" aria-controls="tab-meeting" aria-selected="true"><span class="fa-brands fa-slideshare me-2 tab-icon-color"></span>Conceptos Habilitados</a>
                                        </li>
                                      </ul>

                                      <div class="tab-content" id="myTabContent">
                                         <div class="tab-pane fade active show" id="tab-activity" role="tabpanel" aria-labelledby="activity-tab">
                                            <h4 class="mt-3 mb-0">Datos principales</h4>
                                      ...
                                      <div class="tab-content mb-4" id="myTabContent">
                                          <div class="tab-pane fade" id="tab-notes" role="tabpanel" aria-labelledby="activity-tab">
                                            <h4 class="mt-3 mb-3">Datos de conexión</h4>
                                            <div class="row g-3 mt-0">
                                                 <div class="col-xl-12">
                                                   <div class="row gx-3 gy-4">
                                      ...
                                      <div class="tab-content" id="myTabContent">
                                          <div class="tab-pane fade" id="tab-meeting" role="tabpanel" aria-labelledby="activity-tab">
                                            <h4 class="mt-3 mb-2">Conceptos Habilitados</h4>
                                            <div class="row g-3 mt-0">
                                                 <div class="col-xl-12">
                                                   <div class="row gx-3 gy-4">
                                      ...
                                      <div class="col-12 gy-6">
                                          <div class="row g-3 justify-content-end">
                                            ...
                                            <div class="col-auto">
                                              <button class="btn btn-primary px-5 px-sm-15" type="button" data-bs-toggle="modal" data-bs-target="#confirmModal" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" >Guardar</button>
                                            </div>
                                          </div>
                                      </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                          <div class="modal-content border">
                                            ...
                                            <div class="modal-footer d-flex justify-content-end align-items-center px-0 pb-0 border-200 pt-0">
                                                ...
                                                <button class="btn btn-sm btn-primary px-9 my-0 mt-1" onclick="submitFrmGeneral();" type="submit" data-bs-dismiss="modal" >Confirmar</button>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
