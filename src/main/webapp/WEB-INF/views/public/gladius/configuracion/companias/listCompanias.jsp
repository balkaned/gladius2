          ...
          <div class="content">
            ...
            <div class="mb-9">
              <div class="row g-3 mb-4">
                <div class="col-auto">
                  <h2 id="h2top" class="mb-0">Compañias</h2>
                </div>
              </div>
                ...
                <div class="mb-4">
                  <div class="row g-3">
                    ...
                    <div class="col-auto">
                      ...
                      <a class="btn btn-primary" href="nuevaCompania" ><span class="fas fa-plus me-2"></span>Add Compañia</a>
                    </div>
                  </div>
                </div>
                    ...
                    <table class="table table-sm fs--1 mb-0">
                      <thead>
                        <tr>
                          ...
                          <th class="sort align-middle text-center ps-5" scope="col" data-sort="date">COMPANIA</th>
                          <th class="sort align-middle text-center ps-6" scope="col" data-sort="date">RUC</th>
                          <th class="sort align-middle text-center ps-3" scope="col" data-sort="date">REP</th>
                          <th class="sort align-middle text-center ps-5" scope="col" data-sort="date">PUESTO</th>
                          <th class="sort align-middle text-center ps-5" scope="col" ></th>
                        </tr>
                      </thead>
                      <tbody class="list" id="order-table-body">
                          <c:forEach var="LstCompania" items="${requestScope.LstCompania}">
                              ...
                              <td class="align-middle text-end white-space-nowrap pe-0 action">
                                 <div class="font-sans-serif btn-reveal-trigger position-static">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-end py-2">
                                     <a id="dropdownmenutable" class="dropdown-item" href="editarCompania@${LstCompania.idCodcia}"><span class="fa-solid fa-screwdriver-wrench me-2"></span>Editar configuración</a>
                                     <div class="dropdown-divider"></div>
                                     <a id="dropdownmenutable" class="dropdown-item" onclick="return remove();" href="deleteCompania@${LstCompania.idCodcia}"><span class="fa-solid fa-trash me-2"></span>Eliminar</a>
                                   </div>
                                 </div>
                              </td>
                            </tr>
