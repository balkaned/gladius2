      ...
      <ul class="navbar-nav navbar-nav-icons flex-row">
        ...
        <li class="nav-item">
          <div class="theme-control-toggle fa-icon-wait px-2">
            ...
            <label class="mb-0 theme-control-toggle-label theme-control-toggle-dark bg-dark border border-500" for="themeControlToggle" data-bs-toggle="tooltip" data-bs-placement="left" title="Cambiar tema"><span class="icon colorwhite" data-feather="sun"></span></label>
          </div>
        </li>
