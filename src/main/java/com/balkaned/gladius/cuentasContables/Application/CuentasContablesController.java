package com.balkaned.gladius.cuentasContables.Application;

import com.balkaned.gladius.cuentasContables.Domain.CuentaContable;
import com.balkaned.gladius.cuentasContables.Domain.CuentasContablesService;
...
public class CuentasContablesController {
    ...
    public ModelAndView editarCuentaContable(ModelMap model, HttpServletRequest request, @PathVariable String idCContable) {
        ...
        com.balkaned.gladius.cuentasContables.Domain.CuentaContable xC = cuentasContablesService.getCuentaContable(idCompania, idCContable);
        if (xC == null) {
            return new ModelAndView("redirect:/listarCuentasContables?notfound=1");
        }
        model.addAttribute("xCcontable", xC);
