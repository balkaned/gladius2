package com.balkaned.gladius.usuarios.Application;
...
import com.balkaned.gladius.roles.Domain.RolService;
import com.balkaned.gladius.services.*;
import com.balkaned.gladius.servicesImpl.Sessionattributes;
import com.balkaned.gladius.usuarios.Domain.Usuario;
import com.balkaned.gladius.usuarios.Domain.UsuarioService;
...
public class UsuariosController {
    ...
    public ModelAndView deleteUsuario(@PathVariable("id") Integer id, ModelMap model, HttpServletRequest request) {
        log.info("/deleteUsuario");
