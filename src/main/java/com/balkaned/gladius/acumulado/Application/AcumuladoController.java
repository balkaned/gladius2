package com.balkaned.gladius.acumulado.Application;

import com.balkaned.gladius.acumulado.Domain.AcumuladoService;
...
public class AcumuladoController {
    ...
    public ModelAndView insertarAcumulado(ModelMap model, HttpServletRequest request) {
        ...
        if (result > 0) {
            ...
            return new ModelAndView("redirect:/acumulado@" + iexcodtra + "?saved=1");
        }
    }
