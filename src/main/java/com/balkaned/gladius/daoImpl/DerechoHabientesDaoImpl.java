...
public class DerechoHabientesDaoImpl implements DerechoHabientesDao {
    ...
    public DerechoHabiente recuperar(DerechoHabiente derhab) {
        ...
        String sql = " select d.iexcodcia, " +
                ...
                " d.iextipnroiddep = j.iexkey  and "+
                " d.iexcodcia = "+derhab.getIexcodcia()+" and "+
                " d.iexcodtra = "+derhab.getIexcodtra()+" and  d.iexcoddep = "+derhab.getIexcoddep()+" ";

        return (DerechoHabiente) template.query(sql, new ResultSetExtractor<DerechoHabiente>() {
            public DerechoHabiente extractData(ResultSet rs) throws SQLException, DataAccessException{
                DerechoHabiente p = new DerechoHabiente();
    ...
    public void eliminar(DerechoHabiente derhab){
        ...
        template.update(" delete from iexempderhab  where  iexcodcia=?  and iexcodtra=?  and iexcoddep=? ",
