package com.balkaned.gladius.empleado.Application;
...
public class EmpleadoController {
    ...
    public ModelAndView detalleEmpl(ModelMap model, HttpServletRequest request, @PathVariable String idTrab) {
        ...
        model.addAttribute("lovLarDistancia", lovsService.getLovs("26", "%")); // Cambiamos de 29 a 26 para traer los paises y no departamentos del peru
        model.addAttribute("lovEstcivil", lovsService.getLovs("68", "%"));
        model.addAttribute("lovDept_origen", lovsService.getLovsDept("", emp.getIexpaisemisor()));  // enlista los departamentos que tiene registrado el trabajdor
        model.addAttribute("lovProvin_origen", lovsService.getLovsProv("", emp.getIexdepart_origen()));   // enlista los departamentos que tiene registrado el trabajdor
        model.addAttribute("lovDist_origen", lovsService.getLovsDist("", emp.getIexprovin_origen()));   // enlista los departamentos que tiene registrado el trabajdorss
        ...
        model.addAttribute("lovDept_origen1", lovsService.getLovsDept("", emp5.getIexnacion_origen1()));  // enlista los departamentos que tiene registrado el trabajdor
        model.addAttribute("lovProvin_origen1", lovsService.getLovsProv("", emp5.getIexdepart_origen1()));   // enlista los departamentos que tiene registrado el trabajdor
        model.addAttribute("lovDist_origen1", lovsService.getLovsDist("", emp5.getIexprovin_origen1()));   // enlista los departamentos que tiene registrado el trabajdor
        model.addAttribute("lovDept_origen2", lovsService.getLovsDept("", emp5.getIexnacion_origen2()));  // enlista los departamentos que tiene registrado el trabajdor
        model.addAttribute("lovProvin_origen2", lovsService.getLovsProv("", emp5.getIexdepart_origen2()));   // enlista los departamentos que tiene registrado el trabajdor
