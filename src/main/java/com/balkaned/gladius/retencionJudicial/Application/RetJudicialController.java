package com.balkaned.gladius.retencionJudicial.Application;
...
import com.balkaned.gladius.retencionJudicial.Domain.RetJudicialService;
...
public class RetJudicialController {
    ...
    public ModelAndView insertarRetencion(ModelMap model, HttpServletRequest request) {
        ...
        return new ModelAndView("redirect:/retencionJud@" + iexcodtra + "?saved=1");
    }
