...
public class CompaniaServiceImpl implements CompaniaService {
    ...
    public Compania getCompania(Integer codcia){return dao.getCompania(codcia);}
    public List<Ciaxcon> listarCiaxcon(Integer codcia,String flgtipreg){return dao.listarCiaxcon(codcia,flgtipreg);}
    public void actualizarCompania(Compania com){dao.actualizarCompania(com);}
    public void insertarCiaxcion(Integer codcia,String codcon,String tipreg){dao.insertarCiaxcon(codcia,codcon,tipreg);}
    public void deleteCiaxcon(Integer codcia,String codcon){dao.deleteCiaxcon(codcia,codcon);}
}
