...
public class VacacionesServiceImpl implements VacacionesService {
    ...
    public List<VacacionProgramacion> listaVacacionesGen(Integer codcia,String regimen, String fecini , String fecfin ,Integer codtra){return dao.listaVacacionesGen(codcia,regimen,fecini,fecfin,codtra);}
    ...
    public void insertarVacacionPrg(VacacionProgramacion vacprg){dao.insertarVacacionPrg(vacprg);}
    public void procesaVacacionCtl(Empleado empleado){dao.procesaVacacionCtl(empleado);}
    public void actualizarVacacionPrg(VacacionProgramacion vacprg){dao.actualizarVacacionPrg(vacprg);}
    public VacacionProgramacion getVacacionPrg(VacacionProgramacion vacprg){return dao.getVacacionPrg(vacprg);}
}
