...
public class AusentismoServiceImpl implements AusentismoService {
    ...
    public List<AusentismoProgramacion> listaAusentismoGen(Integer codcia, String regimen, String fecini , String fecfin , Integer codtra ){return dao.listaAusentismoGen(codcia,regimen,fecini,fecfin,codtra);}
