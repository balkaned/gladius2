package com.balkaned.gladius.prestamo.Application;
...
import com.balkaned.gladius.prestamo.Domain.PrestamoService;
...
public class PrestamoController {
    ...
    public ModelAndView insertarPrestamo(ModelMap model, HttpServletRequest request) {
        ...
        return new ModelAndView("redirect:/prestamos@" + iexcodtra + "?saved=1");
    }
